...
a_list = [86210392, 39408901, 100749785, 43127482, 44325545, 64746739, 54673003, 74746118]
asyncio.get_event_loop().run_until_complete(get_data(articuls_list=a_list))


# input_str = '86210392 39408901 100749785 43127482 44325545 64746739 54673003 74746118'
